...
(function (global) {
  ...
  var WC_VOLUNTEER_TILES = [
    {
      ...
      body: '10:00 AM – 3:00 PM · Hourly slots (10–11 … 2–3) · Prayer tents · NRG Stadium area',
    ...
    },
    {
      ...
      body: '10:00 AM – 3:00 PM · Hourly slots · Prayer tents · NRG Stadium area',
    ...
    },
    {
      ...
      body: '4:00 PM – 9:00 PM · Hourly slots · Prayer tents · NRG Stadium area',
    ...
    },
    {
      ...
      body: '10:00 AM – 3:00 PM · Hourly slots · Prayer tents · NRG Stadium area',
      img: 'https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=800&q=80&auto=format&fit=crop',
  ...
  function tileArticle(tile, extraClass) {
    ...
    if (
      ...
      window.PrayerCityStockImages &&
      typeof window.PrayerCityStockImages.fixUrl === 'function'
    ) {
      imgSrc = window.PrayerCityStockImages.fixUrl(imgSrc);
    }
    var imgFallback =
      (typeof window !== 'undefined' &&
        window.PrayerCityStockImages &&
        window.PrayerCityStockImages.FALLBACK) ||
